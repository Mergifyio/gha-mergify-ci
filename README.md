...
`action: scopes-upload`, with or without concrete `scopes`, and requires
mergify-cli 2026.7.8.1 or newer (see the `mergify_cli_version` input if the
pinned default is older).
